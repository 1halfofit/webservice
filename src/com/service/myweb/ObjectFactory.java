 ...
 * generated in the com.offcn.myweb package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValueResponse_QNAME = new QName("http://bo.com/", "getValueResponse");
    private final static QName _GetValue_QNAME = new QName("http://bo.com/", "getValue");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.service.myweb
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bo.com/", name = "getValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bo.com/", name = "getValue")
